...
class _JournalScreenState extends State<JournalScreen> {
  ...
  String get _formattedSelectedDateISO => DateFormat('yyyy-MM-dd').format(_selectedDate);
  ...
  Future<void> _saveJournal() async {
    ...
    if (tasks.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please describe the activities & tasks accomplished today.'),
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              Expanded(child: Text(res['message'] ?? 'Daily journal saved successfully!')),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    final bool isToday = DateFormat('yyyy-MM-dd').format(DateTime.now()) == _formattedSelectedDateISO;
    final String dateLabel = isToday ? "Today, ${DateFormat('MMMM d, yyyy').format(_selectedDate)}" : DateFormat('EEEE, MMMM d, yyyy').format(_selectedDate);
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    const Icon(Icons.edit_calendar_rounded, size: 18, color: primaryNavy),
                    ...
                    if (_currentJournal != null) _buildStatusAndFeedbackCard(_currentJournal!),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              const Icon(Icons.assignment_outlined, color: primaryNavy, size: 20),
                              const SizedBox(width: 6),
                              const Text(
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: 'e.g., Assisted department staff with network maintenance, backed up database records, resolved PC troubleshooting tickets...',
                          ...
                          Row(
                            children: [
                              const Icon(Icons.lightbulb_outline_rounded, color: primaryNavy, size: 20),
                              const SizedBox(width: 6),
                              const Text(
                          ...
                          TextFormField(
                            ...
                            maxLines: 3,
                            decoration: InputDecoration(
                              hintText: 'e.g., Learned how subnet masking works in enterprise networks; practiced professional customer communication...',
                              hintStyle: TextStyle(fontSize: 12.5, color: Colors.grey.shade400),
                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.grey.shade300)),
                              contentPadding: const EdgeInsets.all(12),
                            ),
                          ...
                          Row(
                            children: [
                              const Icon(Icons.troubleshoot_rounded, color: primaryNavy, size: 20),
                              const SizedBox(width: 6),
                              const Text(
                          ...
                          TextFormField(
                            ...
                            maxLines: 2,
                            decoration: InputDecoration(
                              hintText: 'e.g., IP conflict occurred on printer; resolved by checking DHCP leases...',
                              hintStyle: TextStyle(fontSize: 12.5, color: Colors.grey.shade400),
                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.grey.shade300)),
                              contentPadding: const EdgeInsets.all(12),
                            ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              label: Text(
                                _currentJournal != null ? 'Update Daily Narrative Report' : 'Submit Today\'s Narrative Report',
                    ...
                    if (_pastJournals.isNotEmpty) ...[
                      ...
                      ListView.separated(
                        ...
                        itemBuilder: (ctx, i) {
                          ...
                          final String itemDate = item['formatted_date'] ?? item['entry_date'] ?? '';
                          final bool isSelected = (item['entry_date'] ?? '').toString().startsWith(_formattedSelectedDateISO);
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      _buildSmallStatusBadge(item['dean_status'] ?? 'Pending'),
                                    ],
                                  ),
                                  const SizedBox(height: 4),
                                  Text(
                                  ...
                                  if ((item['dean_feedback'] ?? '').toString().isNotEmpty) ...[
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          const Icon(Icons.chat_bubble_outline, size: 12, color: Color(0xFF0369A1)),
                                          ...
                                          Expanded(
                                            child: Text(
                                              ...
                                              maxLines: 1,
                                              overflow: TextOverflow.ellipsis,
                                              style: const TextStyle(fontSize: 11, fontStyle: FontStyle.italic, color: Color(0xFF0369A1)),
                                            ),
                                          ),
                                        ],
                                      ),
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    feedback,
                    style: const TextStyle(fontSize: 12.5, fontStyle: FontStyle.italic, color: primaryNavy),
                  ),
                ),
              ],
            ),
